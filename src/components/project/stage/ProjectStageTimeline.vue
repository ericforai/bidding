...
const STAGES = Object.freeze([
  { code: 'INITIATION', title: '立项', route: 'initiation' },
  { code: 'DRAFTING', title: '标书编制', route: 'drafting' },
  { code: 'EVALUATION', title: '评标', route: 'evaluation' },
  { code: 'RESULT', title: '结果确认', route: 'result' },
  { code: 'RETROSPECTIVE', title: '复盘', route: 'retrospective' },
  { code: 'CLOSURE', title: '结项', route: 'closure' },
])
...
const currentCode = computed(() => snapshot.value?.currentStage || props.initialStage || 'INITIATION')
