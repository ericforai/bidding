<template>
  <section class="customer-detail-panel">
    <el-skeleton :loading="loading" animated :rows="15">
      <div v-if="viewState.showDetail" class="detail-container scrollable">
      ...
      <div v-else-if="viewState.showOnboarding" class="smart-onboarding">
        <div class="onboarding-content">
          ...
          <div class="onboarding-suggestions">
            ...
            <div class="suggest-cards">
              <div class="s-card" @click="$emit('select-first-high-value')">
                <el-icon><Star /></el-icon>
                <span>查看高价值潜力客户</span>
              </div>
              <div class="s-card" @click="$emit('recommend-project')">
      ...
      <div v-else-if="viewState.showApiEmpty" class="api-empty-state">
...
<script setup>
import { InfoFilled, MagicStick, Star, TrendCharts } from '@element-plus/icons-vue'
import {
  confidenceColor,
  getStatusLabel,
  getStatusType,
...
defineEmits(['open-history', 'select-first-high-value', 'recommend-project', 'go-bidding'])
</script>
