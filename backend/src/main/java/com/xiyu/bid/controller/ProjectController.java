...
import com.xiyu.bid.dto.ProjectRequest;
import com.xiyu.bid.service.ProjectService;
...
public class ProjectController {
    ...
    public ResponseEntity<ApiResponse<List<ProjectDTO>>> getAllProjects() {
        ...
        return ResponseEntity.ok(
            ApiResponse.success("Successfully retrieved projects", projects)
        );
    }
    ...
    public ResponseEntity<ApiResponse<ProjectDTO>> getProjectById(@PathVariable Long id) {
        ...
        return ResponseEntity.ok(
            ApiResponse.success("Successfully retrieved project", project)
        );
    }
    ...
    public ResponseEntity<ApiResponse<ProjectDTO>> createProject(@Valid @RequestBody ProjectRequest projectRequest) {
        ...
        return ResponseEntity.status(HttpStatus.CREATED).body(
            ApiResponse.success("Project created successfully", createdProject)
        );
    }
    ...
    public ResponseEntity<ApiResponse<ProjectDTO>> updateProjectStatus(
            @PathVariable Long id,
            @RequestParam com.xiyu.bid.entity.Project.Status status) {
        ...
        return ResponseEntity.ok(
            ApiResponse.success("Project status updated successfully", updatedProject)
        );
    }
    ...
    @PutMapping("/{id}/team")
    @PreAuthorize("hasAnyRole('ADMIN', 'MANAGER')")
    public ResponseEntity<ApiResponse<ProjectDTO>> updateProjectTeam(
            @PathVariable Long id,
            @RequestBody List<Long> teamMembers) {
        ...
        return ResponseEntity.ok(
            ApiResponse.success("Project team updated successfully", updatedProject)
        );
    }
    ...
    public ResponseEntity<ApiResponse<List<ProjectDTO>>> getActiveProjects() {
        ...
        return ResponseEntity.ok(
            ApiResponse.success("Successfully retrieved active projects", projects)
        );
    }
