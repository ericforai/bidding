...
public class TenderRequestSanitizer {
    ...
    public void sanitizeCriteria(TenderSearchCriteria criteria) {
        ...
        sanitizeString(criteria::setSource, criteria.getSource(), 200);
        ...
        sanitizeString(criteria::setCustomerType, criteria.getCustomerType(), 100);
        sanitizeString(criteria::setPriority, criteria.getPriority(), 10);
    }
