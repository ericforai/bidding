...
CREATE INDEX IF NOT EXISTS idx_workflow_form_instances_project_status ON workflow_form_instances(project_id, status);
CREATE INDEX IF NOT EXISTS idx_workflow_form_instances_type_status ON workflow_form_instances(business_type, status);
CREATE INDEX IF NOT EXISTS idx_workflow_form_instances_oa ON workflow_form_instances(oa_instance_id);
