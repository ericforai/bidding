...
create index if not exists idx_bid_match_model_status
...
create index if not exists idx_bid_match_version_model
    on bid_match_model_versions (model_id);

create index if not exists idx_bid_match_version_active
    on bid_match_model_versions (active_flag);

create unique index if not exists uk_bid_match_version_model_no
...
create index if not exists idx_bid_match_eval_tender
    on bid_match_score_evaluations (tender_id);

create index if not exists idx_bid_match_eval_version
    on bid_match_score_evaluations (model_version_id);

create index if not exists idx_bid_match_eval_time
