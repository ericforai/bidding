...
create index if not exists idx_bid_tender_doc_snap_project
    on bid_tender_document_snapshots (project_id);

create index if not exists idx_bid_tender_doc_snap_tender
    on bid_tender_document_snapshots (tender_id);

create index if not exists idx_bid_tender_doc_snap_document
...
create index if not exists idx_bid_requirement_items_project
    on bid_requirement_items (project_id);

create index if not exists idx_bid_requirement_items_tender
    on bid_requirement_items (tender_id);

create index if not exists idx_bid_requirement_items_document
