    ...
    create table case_reference_records (
        case_id bigint not null,
        id bigint generated by default as identity,
        referenced_at timestamp(6) not null,
    ...
    create index idx_expense_payment_records_expense_id
       on expense_payment_records (expense_id);

    create index idx_expense_payment_records_paid_at
    ...
    alter table if exists expense_payment_records
       add constraint FK_expense_payment_records_expense
