...
### Req: Status Transition Validation
...
### Req: Abandonment Permission
Only authorized users (ADMIN/MANAGER or users with specific permission) CAN transition a tender to `ABANDONED`.
